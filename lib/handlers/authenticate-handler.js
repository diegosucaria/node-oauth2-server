...
AuthenticateHandler.prototype.getAccessToken = function(token, req) {
  return promisify(this.model.getAccessToken, 1).call(this.model, token, req)
...
AuthenticateHandler.prototype.verifyScope = function(accessToken, req) {
  return promisify(this.model.verifyScope, 2).call(this.model, accessToken, this.scope, req)
    .then(function(scope) {
      if (!scope) {
